...
const p = "/RetroFilmDate/example.png",
  w = "/RetroFilmDate/fonts/alarmClock.ttf";
async function h(a) {
...
function S() {
  const a = `
        ...
        <div>
            <h3>Image Preview</h3>
            <img id="imagePreview" src="${p}" alt="Preview">
        </div>
    `;
  (document.querySelector("#app").innerHTML = a),
    document.querySelector("#imageInput").addEventListener("change", h);
